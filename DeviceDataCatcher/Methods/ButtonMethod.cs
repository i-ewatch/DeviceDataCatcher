...
namespace DeviceDataCatcher.Methods
{
    public class ButtonMethod
    {
        ...
        public void AccordionLoad(AccordionControl accordionControl1, ButtonSetting buttonSetting)
        {
            ...
            {
                Button_Type ButtonType = (Button_Type)item.ButtonStyle;
                switch (ButtonType)
                {
                    case Button_Type.Group: // 群組
                        {
                            //
                            //列表
                            //
